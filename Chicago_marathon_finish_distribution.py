...
axs[1].set_xticks(np.arange(120,301,30))
axs[1].grid(True)

axs[0].scatter(chicago_percentiles, np.arange(0,101,1), label='Chicago Marathon')
axs[0].set_xticks(np.arange(120,301,15))
axs[0].set_xlabel('Finish (mins)')
